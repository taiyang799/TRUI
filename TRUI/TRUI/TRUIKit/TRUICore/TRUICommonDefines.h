...
#ifndef TRUICommonDefines_h
#define TRUICommonDefines_h
...
#define BeginIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.trui_shouldIgnoreUIKVCAccessProhibited = YES;
#define EndIgnoreUIKVCAccessProhibited if (@available(iOS 13.0, *)) NSThread.currentThread.trui_shouldIgnoreUIKVCAccessProhibited = NO;

#pragma mark - 变量-设备相关

/// 设备类型
#define IS_IPAD      [TRUIHelper isIPad]
#define IS_IPOD      [TRUIHelper isIPod]
#define IS_IPHONE    [TRUIHelper isIPhone]
#define IS_SIMULATOR [TRUIHelper isSimulator]

/// 操作系统版本号，只获取第二级的版本号，例如 10.3.1 只会得到 10.3
#define IOS_VERSION ([[[UIDevice currentDevice] systemVersion] doubleValue])

/// 数字形式的操作系统版本号，可直接用于大小比较；如 110205 代表 11.2.5 版本；根据 iOS 规范，版本号最多可能有3位
#define IOS_VERSION_NUMBER [TRUIHelper numbericOSVersion]
...
#define APPLICATION_WIDTH [TRUIHelper applicationSize].width

/// 在 iPad 分屏模式下等于 app 实际运行宽度，否则等同于 DEVICE_HEIGHT
#define APPLICATION_HEIGHT [TRUIHelper applicationSize].height

/// 是否全面屏设备
#define IS_NOTCHED_SCREEN [TRUIHelper isNotchedScreen]
/// iPhone XS Max
#define IS_65INCH_SCREEN  [TRUIHelper is65InchScreen]
/// iPhone XR
#define IS_61INCH_SCREEN  [TRUIHelper is61InchScreen]
/// iPhone X/XS
#define IS_58INCH_SCREEN  [TRUIHelper is58InchScreen]
/// iPhone 6/7/8 Plus
#define IS_55INCH_SCREEN  [TRUIHelper is55InchScreen]
/// iPhone 6/7/8
#define IS_47INCH_SCREEN  [TRUIHelper is47InchScreen]
/// iPhone 5/5S/SE
#define IS_40INCH_SCREEN  [TRUIHelper is40InchScreen]
/// iPhone 4/4S
#define IS_35INCH_SCREEN  [TRUIHelper is35InchScreen]
/// iPhone 4/4S/5/5S/SE
...
#define IS_ZOOMEDMODE [TRUIHelper isZoomedMode]

#pragma mark - 变量-布局相关

/// 获取一个像素
#define PixelOne [TRUIHelper pixelOne]
...
/// @warn 如果是用于 viewController，请使用 UIViewController(TRUI) trui_navigationBarMaxYInViewCoordinator 代替
...
#define SafeAreaInsetsConstantForDeviceWithNotch [TRUIHelper safeAreaInsetsForDeviceWithNotch]
...
#define PreferredValueForNotchedDevice(_notchedDevice, _otherDevice) ([TRUIHelper isNotchedScreen] ? _notchedDevice : _otherDevice)

/// 将所有屏幕按照宽松/紧凑分类，其中 iPad、iPhone XS Max/XR/Plus 均为宽松屏幕，但开启了放大模式的设备均会视为紧凑屏幕
#define PreferredValueForVisualDevice(_regular, _compact) ([TRUIHelper isRegularScreen] ? _regular : _compact)
...
#define IPAD_SIMILAR_SCREEN_WIDTH [TRUIHelper preferredLayoutAsSimilarScreenWidthForIPad]

#define _40INCH_WIDTH [TRUIHelper screenSizeFor40Inch].width
#define _58INCH_WIDTH [TRUIHelper screenSizeFor58Inch].width
#define _65INCH_WIDTH [TRUIHelper screenSizeFor65Inch].width
...
/// 字体相关的宏，用于快速创建一个字体对象，更多创建宏可查看 UIFont+TRUI.h
...
/// UIColor 相关的宏，用于快速创建一个 UIColor 对象，更多创建的宏可查看 UIColor+TRUI.h
...
#define TRUIViewAnimationOptionsCurveOut (7<<16)
#define TRUIViewAnimationOptionsCurveIn (8<<16)
...
#define TRUIStatusBarStyleDarkContent [TRUIHelper statusBarStyleDarkContent]
...
setterWithGetter(SEL getter) {
    ...
    [setterString appendString:getterString.trui_capitalizedString];
