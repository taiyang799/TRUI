...
@implementation TRUIPropertyDescriptor

+ (instancetype)descriptorWithProperty:(objc_property_t)property
{
    TRUIPropertyDescriptor *descriptor = [[TRUIPropertyDescriptor alloc] init];
    ...
    descriptor.type = [TRUIPropertyDescriptor typeWithEncodeString:[NSString stringWithUTF8String:type]];
    if (type != NULL) {
        free(type);
    }
